...
Проект представляет собой веб-приложение на Flask, которое использует обученные модели нейронных сетей для определения координат центра пятна на изображениях. Приложение развёрнуто с помощью Docker и поддерживает CI/CD.
